                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h4 class="card-title mb-">M E N H E R A - P R E M I U M</h4>
                                
<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="DROP YOUR CARDS"></textarea>
    ...
    <option </option>
				...
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/WOOCOMMERCE.php">STRIPE CVV 36$</option>
...
// ảo ma hẄ1¤7, đừng lấy code chỄ1¤7 !!
if(total > 100000000){
